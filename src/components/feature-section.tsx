        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-4 auto-rows-[200px]">
          ...
          >
            ...
            <p className="text-white/80 md:text-lg text-sm leading-relaxed">
              Join the worldwide conversation. Share ideas, meet new people, and
              be part of a vibrant community that spans the globe.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              Have intimate conversations with friends. Your privacy is
              protected.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              Bank-level encryption keeps your conversations secure and private.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              Your messages are encrypted from device to device. Not even we can
              read them.
            </p>
          </motion.div>
        </div>
