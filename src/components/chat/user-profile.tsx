  ...
  return (
    <div className="p-3 md:p-6 space-y-4 md:space-y-6 overflow-y-auto">
      ...
      >
        ...
        <h1 className="text-xl md:text-2xl font-bold text-white mt-4">
          {displayName}
        </h1>
        <p className="text-white/70 text-sm md:text-base">@{user?.username}</p>
        <Badge
          variant="secondary"
          className="mt-2 bg-white/20 text-white border-white/30 text-xs md:text-sm"
        >
          {status}
        </Badge>
      </motion.div>
      ...
      >
        <Card className="bg-white/10 backdrop-blur-sm border-white/20">
          ...
          <CardContent className="space-y-4 pt-0">
            <div>
              <Label className="text-white/90 text-sm md:text-bas">
                Display Name
              </Label>
              {isEditing ? (
                <Input
            ...
            <div>
              <Label className="text-white/90 text-sm md:text-base">
                Username
              </Label>
