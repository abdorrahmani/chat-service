  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12 md:py-20">
      <div className="text-center max-w-4xl mx-auto">
        ...
        >
          Connect, Chat,
          <AuroraText colors={["#fff", "#FF0080", "#ceadee"]}>
            {" "}
            Collaborate
          </AuroraText>
        </motion.h1>
        ...
        >
          Experience seamless communication with our modern chat platform. Join
          global conversations, connect privately, and build meaningful
          relationships.
        </motion.p>
        ...
        >
          <ShimmerButton onClick={openSignup}>Start Chatting Now</ShimmerButton>
          <Button
            variant="outline"
            size="lg"
